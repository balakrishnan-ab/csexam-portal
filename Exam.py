    ...
    if st.session_state.page == 'login':
        ...
        with col2:
            ...
            if not df_raw.empty:
                ...
                num_q = st.number_input(f"வினாக்கள் எண்ணிக்கை:", 1, len(df_sub), min(10, len(df_sub)))
                ...
                if st.button("தேர்வைத் தொடங்கு ➡️", type="primary") and name:
                    ...
                    # இங்குதான் புதிய வினாக்கள் தேர்ந்தெடுக்கப்படுகின்றன
    ...
    # --- 3. முடிவு ---
        ...
        with c1:
            if st.button("🔄 அதே வினாக்களை மீண்டும் எழுத"):
                # இங்கு filtered_df-ஐ மாற்றவில்லை, விடைகளை மட்டும் அழிக்கிறோம்
