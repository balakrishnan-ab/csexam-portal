    ...
    if st.session_state.page == 'login':
        ...
        with col2:
            ...
            if not df_raw.empty:
                ...
                # 2. பயிற்று மொழி (Medium) - மீண்டும் சேர்க்கப்பட்டது
                ...
                # 5. வினாக்கள் எண்ணிக்கை
                num_q = st.number_input(f"வினாக்கள் எண்ணிக்கை (Max: {len(final_df)}):", 1, len(final_df), min(len(final_df), 25))
