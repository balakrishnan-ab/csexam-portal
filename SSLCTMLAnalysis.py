...
if uploaded_file is not None:
    ...
    # டோகிள் சுவிட்ச் அமைப்புகள்
    split_gender = st.toggle("🔍 ஆண் பெண் பிரித்து காட்டு", value=True)
    
    st.write("")
    # ஸ்டேட் மேனேஜ்மென்ட் சிக்கலைத் தவிர்க்க பிரத்யேக 'செயலாக்கு' பட்டன்
    process_button = st.button("🚀 பகுப்பாய்வு செய்க மற்றும் டவுன்லோடு உருவாக்கு", type="primary", use_container_width=True)
    ...
    if process_button:
        ...
        if all_students:
            ...
            # --- 5. Excel கோப்பு பதிவிறக்கம் பொத்தான் உருவாக்கல் ---
